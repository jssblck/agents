...
//
// One native messaging port carries every command the MCP server sends and every result
...
chrome.alarms.create("agent-browser-keepalive", { periodInMinutes: KEEPALIVE_MINUTES });
