// The server side of the bridge: a unix socket every connected browser dials into.
//
...
// server correlates the requests it sends with the responses that come back.
